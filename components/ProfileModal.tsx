                    ...
                    <div className="text-center space-y-4 pt-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <button onClick={handleSendResetLink} disabled={isResetLinkLoading} className={`${buttonClass} text-brand-primary bg-brand-secondary hover:brightness-110`}>
                                {isResetLinkLoading ? "Enviando..." : 'Não lembro minha senha'}
                            </button>
                        </div>
        ...
        >
            ...
            >
                <div className="flex justify-between items-start mb-4">
                    ...
                    <button onClick={onClose} className="text-brand-text-muted hover:text-brand-text text-2xl font-bold">X</button>
                </div>

...
export const GAME_SCENARIOS: GameScenario[] = ['CEv', 'Bounty CVD', 'Bounty CVN', 'Vanilla CVD', 'Vanilla CVN', 'Turbo', 'Hyper', 'Mistery', 'KO', 'NON KO', 'ALL'];
...
export const STATS_ANALYSIS_SCENARIOS: GameScenario[] = ['KO', 'NON KO', 'ALL'];
